...
\parbox{12cm}{
  \vspace{0.2cm}
  \textbf{8) Hvornår er det \emph{tilladt} at se YouTube-videoer for fuld
  udblæsning?} \\
  \texttt{0}: Når kantinen er fyldt med flittige studerende. \quad
  \texttt{X}: Når ingen siger dig imod. \\
...
\parbox{12cm}{
  ...
  \texttt{0}: Spiller Scratch-lyde rigtig højt mens du venter \quad \\
  \texttt{X}: Tager fat i os fysisk eller skriver til \texttt{bestyrelsen@kantinen.org}. \\
  \texttt{1}: Går til øvelsestimer i stedet for at sidde i Kantinen.
  \vspace{0.1cm}
} & & & \\\hline
\parbox{12cm}{
  \vspace{0.2cm}
