...
\parbox{12cm}{
  \vspace{0.2cm}
  \textbf{3) Hvad gjorde KIM HOT \emph{ikke} til børnefødselsdagen?}\\
  \texttt{0}: Fik en ballon-køter. \quad
  \texttt{X}: Legede spaghettikonkurrence. \\
  \texttt{1}: Klædte sig ud som trolden fra Bornholm.
  \vspace{0.1cm}
} & & & \\\hline
\parbox{12cm}{
  \vspace{0.2cm}
